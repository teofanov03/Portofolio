...
import lolapp from "../assets/Images/lolapp.png";

function Projects() {
  const projectSections = [
    {
      id: "aspnet",
      title: "ASP.NET Projects",
      logo: aspnetlogo,
      projects: [
        {
          image: aspnetproject,
          ...
          programClass: "aspnet",
          programName:
            "ASP.NET MVC & Core (Entity Framework, Authentication, CRUD)",
      ...
      projects: [
        {
          ...
          programClass: "php",
          programName:
            "PHP & MySQL (Read the README on github to use admin side)",
      ...
      projects: [
        {
          ...
          programClass: "react",
          programName: "React (API integration, useState, useEffect)",
          link: "https://teofanov03.github.io/React_Movie_Search/",
          githubLink: "https://github.com/teofanov03/React_Movie_Search",
        },
        {
          image: lolapp,
          projectName: "League of Legends Champions",
          programClass: "react",
          programName: "React (Routing, Context API, useEffect)",
          link: "https://teofanov03.github.io/League-of-Legends-Champions-React-app/#/",
          githubLink: "https://github.com/teofanov03/League-of-Legends-Champions-React-app",
        },
      ],
    },
  ];
  ...
  return (
    <div
      id="Projects"
      className="scroll-mt-24 mt-4 min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 py-10 px-5"
    >
      ...
      {projectSections.map((section) => (
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6 border-b border-gray-700 pb-2 flex items-center gap-3">
            <img src={section.logo} alt="" className="w-8 h-8" /> {section.title}
          </h2>
